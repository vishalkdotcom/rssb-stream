...
object RssbPlayerHelper {
    ...
    private fun getDefaultArtist(content: RssbContent): String {
        return when (content.type) {
            com.theveloper.pixelplay.data.model.ContentType.QNA -> "Maharaj Charan Singh"
            com.theveloper.pixelplay.data.model.ContentType.DISCOURSE_MASTER -> "Master"
            com.theveloper.pixelplay.data.model.ContentType.DISCOURSE_DISCIPLE -> "Disciple"
            com.theveloper.pixelplay.data.model.ContentType.SHABAD -> content.author ?: "Unknown Mystic"
            else -> "RSSB"
        }
    }
